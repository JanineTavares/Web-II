            ...
            <section>
              ...
              <form action="../controller/funcionario.controller.php" method="get" name="formfuncionario">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="txtcargo" required>
                </div>
                <div class="form-group">
                  <label for="txtvalorhora">Valor Hora:</label>
                  <input type="number" name="txtvalorhora" required>
                </div>
                <div class="form-group">
                  <label for="txtquantidadehoras">Quantidade de Horas:</label>
                  <input type="number" name="txtquantidadehoras" required >
                </div>
                <div class="form-group">
                  <label for="txthorasextras50">Horas Extras 50:</label>
                  <input type="number" name="txthorasextras50" required>
                </div>
                <div class="form-group">
                  <label for="txthorasextras100">Horas Extras 100:</label>
                  <input type="number" name="txthorasextras100" required>
                </div>
                <div class="form-group">
                  <label for="txtdependentes">Dependentes:</label>
                  <input type="number" name="txtdependentes" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="txtvaletransporte" required>
                </div>
                <div class="form-group">
                  <label for="txtvalerefeicao">Vale Refeição:</label>
                  <input type="number" name="txtvalerefeicao" required >
                </div>
