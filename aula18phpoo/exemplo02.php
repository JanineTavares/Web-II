    ...
    <nav>
      ...
      <section class="conteudo blue lighten-4" style="height:600px">
          ...
          <p class="center-align">
            Programa que leia nome da mercadoria, valor e forma de pagamento.
            <br>
            Caso a forma de pagamento seja à vista - conceder 5% de desconto, caso seja à prazo - acrescer 18% de juros. Retorne os dados e o valor à pagar.
          </p>
          <article class="resposta" style="width:50%; margin:auto; background-color:rgba(174, 169, 176, 0.3); border-radius:20px; padding:20px">

              <?php
                include "mercadoria.class.php";

                $m1 = new Mercadoria();

                $m1->setNome("TV60\"");
                $m1->setValor(1000);
                $m1->setFormaPagamento(1);

                echo "<p>Dados: <br>Nome: ".$m1->getNome().
                     "<br>Valor R$ ".$m1->getValor().
                     "<br>Forma Pagamento: ".$m1->getFormaPagamento().
                    "<br>Valor à pagar R$ ".$m1->calcularValorPagar().
                    "</p>";
               ?>
