		...
		<li> <a href="exercicio1.php"> Exercicio 1 </a></li>
			...
			<section class="conteudo3" id="conteudo3">
				...
				<aside class="exemplo">
					...
					echo "<p>Numero 1: ".$calculadora->getNumero1(). "<br>
							 Numero 2: " .$calculadora->getNumero2(). "<br>
							 A soma entre os numeros é:" .$calculadora->somar(). "<br>
							 A multiplicação entre os numeros é:" .$calculadora->multiplicar(). "<br>
							 A divisão entre os numeros é:" .$calculadora->dividir(). "<br>
							 A raiz quadrada do primeiro numero é:" .$calculadora->calcularRaiz1(). "<br>
							 A raiz quadrada do segundo numero é:" .$calculadora->calcularRaiz2(). "<br>
					</p>"
			...
			<footer class="rodape page-footer font-small blue pt-4">
			</footer>
